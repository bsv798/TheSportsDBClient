...
namespace TheSportsDbTests
{
    public class TheSportsDbClientTests
    {
        ...
        public async Task GetEventByTitleAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Event[0]);
        }

        [Fact]
        public async Task GetEventByTitleAsyncFile()
        {
            // Act
            var result = await _client.GetEventByTitleAsync(null, null, null, "English_Premier_League_2015-04-26_Arsenal_vs_Chelsea");
        ...
        public async Task GetPlayerByNameAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Player[0]);
        }
        ...
        public async Task GetVenueByNameAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Venues[0]);
        }
        ...
        public async Task GetLeagueByIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Leagues[0]);
        }

        [Fact(Skip = "Dost not have model class")]
        public async Task GetTableByIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Tables[0]);
        }
        ...
        public async Task GetEquipmentByIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Equipment[0]);
        }
        ...
        public async Task GetPlayerByIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Players[0]);
        }
        ...
        public async Task GetHonourByIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Honours[0]);
        }
        ...
        public async Task GetFormerTeamsByPlayerIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Formerteams[0]);
        }
        ...
        public async Task GetMilestonesByPlayerIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Milestones[0]);
        }
        ...
        public async Task GetContractsByPlayerIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Contracts[0]);
        }
        ...
        public async Task GetEventByIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Events[0]);
        }
        ...
        public async Task GetLineupByEventIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Lineup[0]);
        }
        ...
        public async Task GetTimelineByEventIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Timeline[0]);
        }
        ...
        public async Task GetEventStatsByIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Eventstats[0]);
        }
        ...
        public async Task GetTVByEventIdAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Tvevent[0]);
        }
        ...
        public async Task GetAllSportsAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Sports[0]);
        }
        ...
        public async Task GetAllCountriesAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Countries[0]);
        }
        ...
        public async Task SearchAllSeasonsAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Seasons[0]);
        }
        ...
        public async Task GetEventsByTVAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Tvevents[0]);
        }
        ...
        public async Task GetEventHighlightsAsync()
        {
            ...
            // Assert
            Assert.NotNull(result.Tvhighlights[0]);
        }
